...
Retraceur offers a set of specific functionality that may be enabled within a theme. The theme needs to opt-in for the feature a support is provided for. This process have to be specified into the theme's `functions.php` file. A nice feature regarding [Retraceur positioning](https://retraceur.github.io/about/) that every Retraceur theme should support is [Post Formats](./post-formats).

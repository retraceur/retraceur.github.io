...
Lorsque le répertoire d'une extension n’existe pas encore sur votre site, Retraceur créera un nouveau répertoire pour celle-ci dans le répertoire parent `/wp-content/plugins` de votre site Web et y déversera le contenu de l'archive ZIP. Ensuite, Retraceur vous informera du succès ou de l'échec de l'opération.
...
![Extension activée](../../../../assets/images/manage-plugins-activate-fr-002.png)
...
![Extensions activées](../../../../assets/images/manage-plugins-activate-fr-004.png)
...
![Extension désactivée](../../../../assets/images/manage-plugins-deactivate-fr-002.png)
...
![Extension désactivées](../../../../assets/images/manage-plugins-deactivate-fr-004.png)

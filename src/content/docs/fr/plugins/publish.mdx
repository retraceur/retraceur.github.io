...
## 1. Ajoutez un « [topic](https://docs.github.com/fr/repositories/managing-your-repositorys-settings-and-features/customizing-your-repository/classifying-your-repository-with-topics) » à votre dépôt
...
<Aside type="tip">
	Vous pouvez ajouter autant de « topics » séparés par des virgules à votre dépôt (un peu comme les étiquettes d'article dans Retraceur. L'essentiel est que l'un d'entre eux soit `retraceur-plugin` ou `retraceur-block` en fonction du type de votre projet.
</Aside>
...
<Aside type="tip">
	Vous pouvez également ajouter dans ce répertoire une image `PNG` nommée `og-image.png`. Si ce fichier est présent, l'**API de découverte de Retraceur** l'utilisera pour illustrer votre dépôt dans l'écran d'administration de découverte des extensions ou des blocs du site de l'utilisateur·rice.
</Aside>

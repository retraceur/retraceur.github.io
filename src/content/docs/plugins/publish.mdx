...
When your Plugin or Block is hosted on GitHub, you can make it part of the **Retraceur Discovery API**. This is not a submission to a central marketplace: Retraceur simply reads a few conventions applied directly to your repository, and discovers your project at the source — the same way any of its users would find it on GitHub.
...
## 1. [Tag](https://docs.github.com/en/repositories/managing-your-repositorys-settings-and-features/customizing-your-repository/classifying-your-repository-with-topics) your repository

...
When your Plugin or Block is hosted on GitHub, you can make it discoverable by the **Retraceur Discovery API**. This is not a submission to a central marketplace: Retraceur simply reads a few conventions applied directly to your repository, and discovers your project at the source — the same way any of its users would find it on [GitHub.com](https://github.com/explore).
...
## 1. Add a specific [Topic](https://docs.github.com/en/repositories/managing-your-repositorys-settings-and-features/customizing-your-repository/classifying-your-repository-with-topics) to your repository
...
<Aside type="tip">
    You can add as many "topics" as you like to your repository, separated by commas (similar to post tags in Retraceur). The important thing is that one of them needs to be `retraceur-plugin` or `retraceur-block`, depending on your project type.
</Aside>
...
| <div style="width:175px">Header tag</div> | Required | Description |
| --- | --- | --- |
...
<Aside type="tip">
    You can also include into this directory a `PNG` image named `og-image.png`. If this file is available, the **Retraceur Discovery API** will use it to illustrate your repository inside the User's Discovery Administration screen.
</Aside>
